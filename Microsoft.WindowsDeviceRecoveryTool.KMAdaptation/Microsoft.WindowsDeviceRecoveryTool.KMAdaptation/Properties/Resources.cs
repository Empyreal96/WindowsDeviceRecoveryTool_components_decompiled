...
namespace Microsoft.WindowsDeviceRecoveryTool.KMAdaptation.Properties
{
	...
	internal class Resources
	{
		...
		internal static ResourceManager ResourceManager
		{
			get
			{
				...
				{
					ResourceManager resourceManager = new ResourceManager("Microsoft.WindowsDeviceRecoveryTool.KMAdaptation.Properties.Resources", typeof(Resources).Assembly);
		...
		internal static string FriendlyName_Soul2
		{
			get
			{
				return Resources.ResourceManager.GetString("FriendlyName_Soul2", Resources.resourceCulture);
			}
		}

		// Token: 0x17000006 RID: 6
		// (get) Token: 0x0600000F RID: 15 RVA: 0x000024D0 File Offset: 0x000006D0
		internal static Bitmap Kruger_Matz_logo
		{
			get
			{
				object @object = Resources.ResourceManager.GetObject("Kruger_Matz_logo", Resources.resourceCulture);
		...
		internal static Bitmap Move_4_2
		{
			get
			{
				object @object = Resources.ResourceManager.GetObject("Move_4_2", Resources.resourceCulture);
				return (Bitmap)@object;
			}
		}
