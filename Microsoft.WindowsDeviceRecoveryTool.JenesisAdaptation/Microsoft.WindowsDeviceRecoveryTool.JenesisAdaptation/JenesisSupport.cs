...
namespace Microsoft.WindowsDeviceRecoveryTool.JenesisAdaptation
{
	...
	internal class JenesisSupport : IDeviceSupport
	{
		...
		public Guid Id
		{
			get
			{
				return JenesisSupport.SupportGuid;
			}
		}
		...
		private static readonly Guid SupportGuid = new Guid("51E93B39-75D1-4F52-9F0F-D7BA579DAEE1");

		// Token: 0x04000004 RID: 4
		private static readonly ManufacturerInfo McjManufacturerInfo = new ManufacturerInfo(Resources.FriendlyName_Manufacturer, Resources.jenesis_logo);
