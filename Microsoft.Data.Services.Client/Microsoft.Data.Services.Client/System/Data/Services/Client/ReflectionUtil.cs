...
namespace System.Data.Services.Client
{
	...
	{
		// Token: 0x06000612 RID: 1554 RVA: 0x00017314 File Offset: 0x00015514
		static ReflectionUtil()
		{
			...
			ReflectionUtil.s_methodMap = new Dictionary<MethodInfo, SequenceMethod>(EqualityComparer<MethodInfo>.Default);
			ReflectionUtil.s_inverseMap = new Dictionary<SequenceMethod, MethodInfo>(EqualityComparer<SequenceMethod>.Default);
		...
		// Token: 0x06000613 RID: 1555 RVA: 0x0001839C File Offset: 0x0001659C
		...
		// Token: 0x06000614 RID: 1556 RVA: 0x000183C0 File Offset: 0x000165C0
		...
		// Token: 0x06000615 RID: 1557 RVA: 0x000183E4 File Offset: 0x000165E4
		internal static bool IsSequenceSelectMethod(MethodInfo method)
		{
			SequenceMethod sequenceMethod;
			if (ReflectionUtil.TryIdentifySequenceMethod(method, out sequenceMethod))
			{
		...
		// Token: 0x06000616 RID: 1558 RVA: 0x00018422 File Offset: 0x00016622
		internal static bool IsAnyAllMethod(SequenceMethod sequenceMethod)
		{
			return sequenceMethod == SequenceMethod.Any || sequenceMethod == SequenceMethod.AnyPredicate || sequenceMethod == SequenceMethod.All;
		}

		// Token: 0x06000617 RID: 1559 RVA: 0x00018470 File Offset: 0x00016670
		internal static string GetCanonicalMethodDescription(MethodInfo method)
		{
			...
			{
				Predicate<Type> isGenericParameterPredicate = (Type type) => type.IsGenericParameter;
				genericArgumentOrdinals = (from t in method.GetGenericArguments()
				where isGenericParameterPredicate(t)
		...
		// Token: 0x06000618 RID: 1560 RVA: 0x000185C8 File Offset: 0x000167C8
		...
		// Token: 0x06000619 RID: 1561 RVA: 0x00018669 File Offset: 0x00016869
		internal static IEnumerable<MethodInfo> GetAllLinqOperators()
		{
			return typeof(Queryable).GetPublicStaticMethods().Concat(typeof(Enumerable).GetPublicStaticMethods());
		}
